...
void loop() {
  ...
  if (hasRun) {
    ...
    if (drill == LOW) {
      ...
      //MotorControlDual(900, 500, CCW, 135, 1000, CCW);  //good 
      //MotorControlDual(330, 7500, CCW, 270, 10000, CCW);  //good 

      MotorControlDual(900, 500, CCW, 900, 500, CCW);  //good 
      MotorControlDual(330, 7500, CCW, 330, 7500, CCW);  //good 
